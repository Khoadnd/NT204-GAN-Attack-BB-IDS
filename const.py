...
attack_category_dict = {
    ...
    3: ['buffer_overflow', 'loadmodule', 'perl', 'ps', 'rootkit', 'sqlattack', 'xterm'],  # u2r
    4: ['ftp_write', 'guess_passwd', 'httptunnel', 'imap', 'multihop', 'named', 'phf', 'sendmail', 'snmpgetattack', 'spy', 'snmpguess', 'warezclient', 'warezmaster', 'xlock', 'xsnoop']  # r2l
}

features_binary = ['land', 'logged_in', 'root_shell', 'is_host_login',
                   'is_guest_login', 'urgent', 'wrong_fragment', 'su_attempted']
